          ...
          {duplicatedPlatforms.map((platform, index) => (
            ...
            >
              ...
              >
                ...
                {/* Icon container */}
                <div
                  className={`w-12 h-12 mx-auto mb-3 rounded-xl bg-gradient-to-br ${platform.gradient} flex items-center justify-center shadow-lg`}
                >
                  {platform.icon}
                </div>
                
                {/* Platform name - centered and consistent */}
